...
// Each icon accepts a unique `uid` prefix to avoid SVG gradient ID collisions
// when multiple Sidebar instances are mounted (e.g. desktop + mobile overlay).
const HomeIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-home`;
  return (
    <svg
...
const NewComplaintIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-new`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
const ComplaintsIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-complaints`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
const AssignmentsIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-assignments`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
const AdminsIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-admins`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
const VendorsIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-vendors`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
const UsersIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-users`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
const DepartmentsIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-depts`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
const AnalyticsIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-analytics`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
...
const SosHistoryIcon = ({ active, uid }: { active: boolean; uid: string }) => {
  const gid = `${uid}-sos`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
function SidebarIcon({ label, active, uid }: { label: string; active: boolean; uid: string }) {
  switch (label) {
    case "Home":
      return <HomeIcon active={active} uid={uid} />;
    case "New Complaint":
      return <NewComplaintIcon active={active} uid={uid} />;
    case "My Complaints":
    case "Complaints":
      return <ComplaintsIcon active={active} uid={uid} />;
    case "Assignments":
      return <AssignmentsIcon active={active} uid={uid} />;
    case "Admins":
      return <AdminsIcon active={active} uid={uid} />;
    case "Vendors":
      return <VendorsIcon active={active} uid={uid} />;
    case "Users":
      return <UsersIcon active={active} uid={uid} />;
    case "Departments":
        ...
        <nav className="flex flex-col gap-2.5 text-sm">
          {items.map((item) => {
            ...
            return (
              ...
              >
                <SidebarIcon label={item.label} active={active} uid={uid} />
