...
export default function VendorReportsPage() {
  ...
  return (
    <DashboardShell
      role="vendor"
      title="Incomplete Work Reports"
      subtitle="Review issues raised by faculty on work you marked completed"
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <GlassCard className="p-5 flex flex-col justify-center">
            <span className="text-xs font-semibold uppercase tracking-wider text-muted">Total Reports Against You</span>
            <span className="text-3xl font-extrabold text-heading mt-2 font-mono text-amber-500">{reports.length}</span>
          </GlassCard>
          <GlassCard className="p-5 flex flex-col justify-center">
        ...
        <GlassCard className="p-4">
          <div className="relative">
            <input
              type="text"
              placeholder="Search reports by complaint ID, title, reason, or reporter name..."
              value={searchQuery}
        ...
        {isLoading ? (
          ...
          <div className="rounded-3xl border border-dashed border-border bg-surface/50 p-12 text-center">
            ...
            <p className="mt-4 text-base font-semibold text-heading font-jakarta">All clear!</p>
            <p className="mt-2 text-sm text-muted">No incomplete work reports have been submitted for your assignments.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="space-y-3 max-w-3xl relative">
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-2xs text-muted font-medium pt-1 border-t border-border/20">
                    <span>
                      Reported by Faculty: <strong className="text-body font-semibold">{report.reportedBy}</strong>
                    </span>
                  </div>
                </div>
                ...
                <div className="shrink-0 flex items-center gap-3 relative self-end md:self-auto">
                  ...
                  >
                    <Link href={`/dashboard/vendor/assignments/${report.complaintNo}`}>
                      View Assignment
                    </Link>
                  </Button>
                </div>
